    ...
    <div class="container">
        <form action="{{ route('comics.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="serie" class="form-control" id="serie" placeholder="Enter the series">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="isbn" class="form-control" id="isbn" placeholder="Enter the isbn">
            </div>
            <div class="form-group">
                <label for="poster">Poster url</label>
                <input type="text" name="poster" class="form-control" id="poster" placeholder="Enter the poster url">
            </div>
